...
export const ThemeSwitcher = () => {
  // Initialize with 'system' and update after mount
    ...
    <fieldset className="flex h-8 p-0 m-0 rounded-[999999px] border border-shadow">
        ...
        >
          ...
          <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              className={`group-hover:fill-gray-1000 duration-150 ${theme === "system" ? "fill-gray-1000" : "fill-gray-700"}`}
        ...
        >
          ...
          <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              className={`group-hover:fill-gray-1000 duration-150 ${theme === "light" ? "fill-gray-1000" : "fill-gray-700"}`}
      ...
      <div className="mt-[-1px] mr-[-1px]">
        ...
        <label
          ...
          className={`flex items-center justify-center h-8 w-8 cursor-pointer rounded-[999999px] group${theme === "dark" ? " border-l border-shadow" : ""}`}
        >
          ...
          <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              className={`group-hover:fill-gray-1000 duration-150 ${theme === "dark" ? "fill-gray-1000" : "fill-gray-700"}`}
